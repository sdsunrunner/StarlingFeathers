package starling.utils
{
    ...
    public class AssetManager
    {
        ...
        private var _bitmapDataForHitDic:Dictionary = null;
		...
		public function get bitmapDataForHitDic():Dictionary
		{
			return _bitmapDataForHitDic;
		}
                                      ...
                                      onProgress:Function, onComplete:Function):void
        {
            ...
            function onLoaderComplete(event:Event):void
            {
				...
				if(null == _bitmapDataForHitDic)
					_bitmapDataForHitDic = new Dictionary();
				_bitmapDataForHitDic[name] = Bitmap(content).bitmapData.clone();
